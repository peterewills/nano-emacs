...
(defun nano-theme--org ()
  ...
  (with-eval-after-load 'org
    ...
    (set-face 'org-level-1                     'nano-face-variable-name)
    (set-face 'org-level-2                     'nano-face-function-name)
    (set-face 'org-level-3                          'nano-face-constant)
    (set-face 'org-level-4                     'nano-face-variable-name)
    (set-face 'org-level-5                     'nano-face-function-name)
    (set-face 'org-level-6                          'nano-face-constant)
    (set-face 'org-level-7                     'nano-face-variable-name)
    (set-face 'org-level-8                     'nano-face-function-name)
